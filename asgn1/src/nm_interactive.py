...
def on_click(event):
    ...
    global source_point, destination_point, visited_boxes, traversed_boxes, path
    ...
    if source_point and destination_point:
        ...
        try:
            ...
            # path, visited_boxes, traversed_boxes = nm_pathfinder.find_path(source_point, destination_point, mesh)
            # TODO: remove traversed_boxes
